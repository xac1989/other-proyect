...
import com.scanandgo.mobile.model.TwitterRequest;
...
public class TwitterSupport implements LoginVendor {
	...
	private static final String SCAN_AND_GO_APP = "scanandgo.app";
	...
	public String[] getConfigurationPropertyNames() {
		return new String[] { SCAN_AND_GO_APP, LOGIN_SERVICE_URL };
	}

	@Override
	public void setConfiguration(Properties properties, SSLSocketFactory sslSocketFactory) {
		this.sslSocketFactory = sslSocketFactory;
		this.app = properties.getProperty(SCAN_AND_GO_APP);
