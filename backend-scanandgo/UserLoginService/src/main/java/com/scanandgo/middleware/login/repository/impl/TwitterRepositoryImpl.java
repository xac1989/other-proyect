package com.scanandgo.middleware.login.repository.impl;
...
import com.scanandgo.middleware.login.configuration.ApplicationConfig;
...
public class TwitterRepositoryImpl implements TwitterRepository {
	...
	@Override
	public LoggedUser getUser(String oauthToken, String oauthSecretToken, String app) throws LoginServiceException, UnauthorizedException {
	...
	private Twitter getTwitterInstance(String oauthToken, String oauthSecretToken, String app) {
		...
		cb.setDebugEnabled(true).setOAuthConsumerKey(consumerKey).setOAuthConsumerSecret(consumerSecretKey)
				.setOAuthAccessToken(oauthToken).setOAuthAccessTokenSecret(oauthSecretToken).setIncludeEmailEnabled(true);
