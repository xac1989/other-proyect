...
public class RewardsApiWongV1Test {

	@InjectMocks
	RewardsApiWongV1 rewardsApiWongV1 = new RewardsApiWongV1();
	...
	public void rewardsGetWithEmailSession() throws NotFoundException {
		...
		rewardsApiWongV1.rewardsGet(email, adapterSecurityContext);
	}
	...
	public void rewardsGetWithOutEmailSession() throws NotFoundException {
		...
		rewardsApiWongV1.rewardsGet("", adapterSecurityContext);
	}
