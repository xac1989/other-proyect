...
@Api(value = "Rewards API V2")
@Generated(value = "class com.github.mfpdev.adapters.swagger.codegen.MfpAdapterCodegen", date = "2016-12-26T16:58:25.127-03:00")
@Component
public class RewardsApiWongV2  {
	
	private final Logger logger = Logger.getLogger(RewardsApiWongV2.class.toString());
   ...
   private UserProfileApiService getUserProfileApiService()  {
	...
	public Response rewardsGet(@ApiParam(value = "Email") @QueryParam("email") String email,
