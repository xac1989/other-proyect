 ...
 * @since Jun 19, 2017
 */
public class UserProfileDto extends GenericUserProfile{
	private String id;
	...
	public UserProfileDto(String id, String displayName, Map<String, String> attributes, FavoritesDto favorites,
