package com.cencosud.mobile.order.adapter.r2;
...
@Api(value = "Order Jumbo API V1")
@Component
public class OrderApiJumboV1 {
	@Autowired
	...
	public Response getOrderById(@ApiParam(value = "Order Id", required = true) @PathParam("orderId") String orderId,
		...
		return getOrderApiService().getOrderById(REGION,VERSION,orderId,"1");
	}
