package com.cencosud.mobile.shoppingcart.adapter;
...
public class ShoppingCartAdapter extends MFPJAXRSApplication{

	static Logger logger = Logger.getLogger(ShoppingCartAdapter.class.getName());
