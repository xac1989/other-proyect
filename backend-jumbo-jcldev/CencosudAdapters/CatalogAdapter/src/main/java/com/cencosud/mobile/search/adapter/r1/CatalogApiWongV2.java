...
@Path("/r1/v2")
@Api(value = "Catalog API Region 1 Version 2")
@Component
public class CatalogApiWongV2 {
	
	private static final Logger logger = Logger.getLogger(CatalogApiWongV2.class.getName());
	...
	public static void main(String args[]) throws NotFoundException{
		CatalogApiWongV2 adapter = new CatalogApiWongV2();
