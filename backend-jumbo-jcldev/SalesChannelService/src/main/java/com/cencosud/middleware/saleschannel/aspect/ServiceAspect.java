package com.cencosud.middleware.saleschannel.aspect;
...
public class ServiceAspect {
	...
	@Around("execution(* *(..)) && @annotation(com.cencosud.middleware.saleschannel.annotation.Loggable)")
	public Object aroundCreation(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		printParameters(joinPoint.getArgs());
