...
public class VtexFilters {
	...
	private List<VtexDepartment> departments;
	...
	public List<VtexDepartment> getDepartments() {
		return departments;
	}

	public void setDepartments(List<VtexDepartment> departments) {
	...
	public static class VtexDepartment{
		private Integer quantity;
		private String name;
		private String link;		
		
				
		public VtexDepartment() {
			super();
		}
		
		public VtexDepartment(Integer quantity, String name, String link) {
			super();
			this.quantity = quantity;
			this.name = name;
			this.link = link;
