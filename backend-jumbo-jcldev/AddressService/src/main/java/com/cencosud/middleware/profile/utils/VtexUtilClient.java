...
//	}
	 ...
	 */
	public <T, E> T executeService(String url, E document, Class<T> responseClass, HttpMethod method, boolean urlVtex) {
		return executeService(url, document, responseClass, method, null, null, urlVtex);
	}
	 ...
	 * @return Objeto resultado de parsear la respuesta del servicio invocado.
	 */
	public <T, E> T executeService(String url, E document, Class<T> responseClass, HttpMethod method, Map<String, String> queryParams, boolean urlVtex) {
		return executeService(url, document, responseClass, method, queryParams, null, urlVtex);
	}
	...
	public <T, E> T executeService(String url, E document, Class<T> responseClass, HttpMethod method,
			Map<String, String> queryParams, Map<String, String> headers, boolean urlVtex) {
		return executeServiceAsValid(url, document, responseClass, method, queryParams, headers, urlVtex).getBody();
	}
