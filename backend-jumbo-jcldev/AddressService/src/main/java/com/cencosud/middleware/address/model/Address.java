...
public class Address {
	...
	private BigDecimal[] geoCoordinate;
	...
	public Address(String userId, String addressId, String addressName, String addressType, String postalCode,
			String city, String country, String state, String street, String number, String neighborhood,
			String complement, String reference, String receiverName, BigDecimal[] geoCoordinate) {
		this.userId = userId;
	...
	public BigDecimal[] getGeoCoordinate() {
		return geoCoordinate;
	}

	public void setGeoCoordinate(BigDecimal[] geoCoordinate) {
		this.geoCoordinate = geoCoordinate;
	}
	...
	public String toString() {
		return "Address [userId=" + userId + ", addressId=" + addressId + ", addressName=" + addressName
				...
				+ receiverName + ", geoCoordinate=" + Arrays.toString(geoCoordinate) + "]";
	}
